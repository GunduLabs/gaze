...
The login greeter is separate and off by default, because upstream has no
up-front biometric slot there. Turn it on with:
...
Gaze could not wire itself into /etc/pam.d/kde-fingerprint.
