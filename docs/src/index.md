...
features:
  ...
  - title: Desktop login
    details: Face unlock at login and the lock screen with the GNOME extension, Hyprland's hyprlock, COSMIC's cosmic-greeter, or any PAM-based login manager such as SDDM.
    link: /guide/gnome
